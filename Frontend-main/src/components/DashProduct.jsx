...
export default function DashProduct() {
  ...
  return (
    <div className="w-full min-h-screen flex flex-col items-center pt-6 pb-10 gap-6 bg-gray-50">
      ...
      {/* Header */}
      <div className="w-[95%] lg:w-[80%] flex flex-col sm:flex-row justify-between gap-4">
      ...
      <div className="w-[95%] lg:w-[80%] grid grid-cols-1 md:grid-cols-12 gap-5">
        ...
        {/* Title + Description */}
        <div className="col-span-1 md:col-span-8 p-5 rounded-lg shadow-md border bg-white flex flex-col">
        ...
        {/* Status */}
        <div className="col-span-1 md:col-span-4 p-5 rounded-lg shadow-md border bg-white flex flex-col">
        ...
        {/* Product Image */}
        <div className="col-span-1 md:col-span-8 p-5 rounded-lg border bg-white shadow-md flex flex-col gap-4">
        ...
        {/* Publishing */}
        <div className="col-span-1 md:col-span-4 p-5 rounded-lg shadow-md border bg-white flex flex-col gap-4">
        ...
        {/* Pricing */}
        <div className="col-span-1 md:col-span-8 p-5 rounded-lg shadow-md border bg-white flex flex-col gap-4">
        ...
        <div className="col-span-1 md:col-span-4 p-5 rounded-lg border bg-white shadow-md flex flex-col gap-3">
